...
# Criando funções de download dos dados
@st.cache_data
def converte_csv(df):
...
# Criando o button de download dos dados
st.markdown('Escreve o nome para o arquivo')
